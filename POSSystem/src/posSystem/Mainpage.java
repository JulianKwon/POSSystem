...
public class Mainpage extends JFrame
{
	...
	public static JPanel table()
	{
		...
		l3.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l4.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l5.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l6.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l7.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l8.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l9.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l10.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l11.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l12.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l13.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l14.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l15.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l16.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l17.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l18.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l19.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		l20.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
	...
	public static JPanel order()
	{
		...
		namefield.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
		
		JLabel tname = new JLabel("Å×ÀÌºí¸í");
		tname.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
	...
	public static JPanel menu()
	{
		...
		TitledBorder tab = new TitledBorder(new LineBorder(Color.BLACK), "¸Þ´º");
		tab.setTitleFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 15));
		JPanel pan = new JPanel();
